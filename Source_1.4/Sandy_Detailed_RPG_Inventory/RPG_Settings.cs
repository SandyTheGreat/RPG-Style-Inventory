...
namespace Sandy_Detailed_RPG_Inventory
{
    class Sandy_RPG_Settings : ModSettings
    {
        ...
        public static string Legendary = "Orange";

        public static string Masterwork = "Teal";

        public static string Excellent = "Magenta";

        public static string Good = "Pastel green";

        public static string Normal = "Blue";

        public static string Poor = "Pale lime";

        public static string Awful = "Black";
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(ref Legendary, "Legendary", "Orange");
            Scribe_Values.Look(ref Masterwork, "Masterwork", "Teal");
            Scribe_Values.Look(ref Excellent, "Excellent", "Magenta");
            Scribe_Values.Look(ref Good, "Good", "Pastel green");
            Scribe_Values.Look(ref Normal, "Normal", "Blue");
            Scribe_Values.Look(ref Poor, "Poor", "Pale lime");
            Scribe_Values.Look(ref Awful, "Awful", "Black");
            base.ExposeData();
        }
    }
