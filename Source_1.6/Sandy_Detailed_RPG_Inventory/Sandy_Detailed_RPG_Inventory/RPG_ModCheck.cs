...
namespace Sandy_Detailed_RPG_Inventory
{
    ...
    {
        private static bool RWoMInitialized = false;
        private static bool RWoMIsActive = false;

        private static bool CEInitialized = false;
        private static bool CEIsActive = false;
        ...
        public static bool IsCEActive()
        {
            ...
            for (int i = 0; i < mmdList.Count; i++)
            {
                if (mmdList[i].PackageId == "ceteam.combatextended")
                {
                    CEIsActive = true;
                }
            }
